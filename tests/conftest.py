...
def customer_preference(db, customer):
    """Create a customer preference (requires guestman.contrib.preferences)."""
    if CustomerPreference is None:
        pytest.skip("CustomerPreference not available - install guestman.contrib.preferences")
...
def customer_insight(db, customer):
    """Create a customer insight (requires guestman.contrib.insights)."""
    if CustomerInsight is None:
        pytest.skip("CustomerInsight not available - install guestman.contrib.insights")
