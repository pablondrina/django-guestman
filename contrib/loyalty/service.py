...
from guestman.contrib.loyalty.models import (
    LoyaltyAccount,
    LoyaltyTransaction,
    LoyaltyTier,
    TransactionType,
...
class LoyaltyService:
    ...
    @classmethod
    def enroll(cls, customer_code: str) -> LoyaltyAccount:
        """
    ...
    @classmethod
    def get_account(cls, customer_code: str) -> LoyaltyAccount | None:
    ...
    @classmethod
    def get_balance(cls, customer_code: str) -> int:
        """Get current points balance. Returns 0 if not enrolled."""
        account = cls.get_account(customer_code)
    ...
    def earn_points(
        ...
        with transaction.atomic():
            account = cls._get_active_account_for_update(customer_code)
    ...
    def get_transactions(
        ...
        return list(
            LoyaltyTransaction.objects.filter(
                account__customer__code=customer_code,
                account__customer__is_active=True,
            )[:limit]
        )

    @classmethod
    def _get_active_account(cls, customer_code: str) -> LoyaltyAccount:
        ...
        try:
            ...
            raise GuestmanError("LOYALTY_NOT_ENROLLED", customer_code=customer_code)

    @classmethod
    def _get_active_account_for_update(cls, customer_code: str) -> LoyaltyAccount:
        """
